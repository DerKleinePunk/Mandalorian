...
void printPlayerState(uint8_t type, int value);
...
void setup() {
  ...
  Serial.println();
  Serial.print(F("DFRobot DFPlayer Mini Demo "));
...
void loop() {
  ...
  if (myDFPlayer.available()) {
    printPlayerState(myDFPlayer.readType(), myDFPlayer.read()); //Print the detail message from DFPlayer to handle different errors and states.
